...
\end{equation}
We assume $\rho(g,t)$ is Gaussian which implies its mode coincides with $\bar x$. Furthermore, since $\sigma^2=G+\eta$, we can use equation (\ref{m_rel}) and the chain rule from calculus to find (see SM \S\ref{fit2fit})
\begin{subequations}
\begin{equation}
