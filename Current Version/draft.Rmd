...
author:
  ...
  - name: Luke J. Harmon
    affiliation: University of Idaho
address:
  - code: University of Idaho
    address: Department of Biological Sciences, 875 Perimeter Drive MS 3051, Moscow, Idaho, 83843
footnote:
  - code: 1
...
For cross-referencing to work we need the .aux files.
Hence, we need to run:

  tinytex::pdflatex("SM.tex", clean=FALSE)
  tinytex::pdflatex("draft.tex", clean=FALSE)
  tinytex::pdflatex("SM.tex", clean=FALSE)
...
__Genetic architecture and intraspecific trait distributions__
