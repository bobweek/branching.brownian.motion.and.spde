...
ggsave("~/Gits/branching.brownian.motion.and.spde/wn.png",wn,width=5,height=2.5)
```
...
ggsave("~/Gits/branching.brownian.motion.and.spde/rescaled_plots.png",rescaled_plots,device="png",width=6,height=6,units="in",dpi=350)
```
...
ggsave("~/Gits/branching.brownian.motion.and.spde/community_dynamics.png",community_plot,width=6.5,height=5,dpi=320)
...
ggsave("~/Gits/branching.brownian.motion.and.spde/on_pl.png",on_pl,device="png",width=3.5,height=3.5,units="in",dpi=350)
...
ggsave("~/Gits/branching.brownian.motion.and.spde/interaction_networks.png",coevs,device="png",width=6,height=6,units="in",dpi=350)
...
ggsave("~/Gits/branching.brownian.motion.and.spde/on_pl.png",on_pl2,device="png",width=3.5,height=3.5,units="in")
```
...
ggsave("~/Gits/branching.brownian.motion.and.spde/cov.png",cov_plot,width=6.5,height=2.5)
```
...
knitr::include_graphics('/home/bb/Gits/branching.brownian.motion.and.spde/cov.png')
```
...
ggsave("/home/bb/Gits/branching.brownian.motion.and.spde/corrs.png",  corrsp,  width=6.5,height=2.5)
ggsave("/home/bb/Gits/branching.brownian.motion.and.spde/Cαℭp.png",   Cαℭp,  width=4,height=2.5)
```
...
knitr::include_graphics('/home/bb/Gits/branching.brownian.motion.and.spde/Cαℭp.png')
```
